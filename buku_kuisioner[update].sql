...
CREATE TABLE `kategori1` (
  ...
  CONSTRAINT `fk_id_anggota1` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
...
CREATE TABLE `kategori10` (
  ...
  CONSTRAINT `fk_id_anggota10` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori2` (
  ...
  CONSTRAINT `fk_id_anggota2` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori3` (
  ...
  CONSTRAINT `fk_id_anggota3` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori4` (
  ...
  CONSTRAINT `fk_id_anggota4` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori5` (
  ...
  CONSTRAINT `fk_id_anggota5` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori6` (
  ...
  CONSTRAINT `fk_id_anggota6` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori7` (
  ...
  CONSTRAINT `fk_id_anggota7` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori8` (
  ...
  CONSTRAINT `fk_id_anggota8` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kategori9` (
  ...
  CONSTRAINT `fk_id_anggota9` FOREIGN KEY (`id_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kunjungan` (
  ...
  CONSTRAINT `fk_indeks_anggota` FOREIGN KEY (`indeks_anggota_fk`) REFERENCES `anggota` (`indeks_anggota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
